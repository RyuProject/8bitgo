...
assert.match(serverIndex, /app\.get\('\/ppsspp\/v0dbfaca'[\s\S]*?CACHE\.none[\s\S]*?index\.html\?embed=1&r=16/, '旧 PSP bundle 的无 index 入口必须跳到当前运行时，不能继续 404 到超时')
...
assert.match(adapter, /index\.html\?embed=1&r=16/)
