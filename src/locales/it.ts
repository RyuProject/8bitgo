...
const it: Translation = {
  ...
  keymap: {
    ...
    kickM: 'Calcio medio',
    kickH: 'Calcio forte',
    coin: 'Inserisci gettone',
    arcadeNote: 'Layout a sei tasti. Le schede a tre (il primo Street Fighter II) usano solo i pugni.',
    passthrough: 'Questi giochi ricevono la tastiera direttamente: i comandi li decide il gioco stesso, di solito nella sua guida o nelle opzioni.',
    customizable: 'Puoi rimapparli dall’icona del gamepad 🎮 nella barra in basso del player.',
    notCustomizable: 'Questo motore non ha un menu per rimappare i tasti.',
    gamepad: 'I gamepad vengono rilevati in automatico e su smartphone compaiono i pulsanti a schermo.',
    numpad: 'Tastierino',
    player2Note: 'Il NES è sempre stato a due giocatori: il 2P usa il tastierino numerico e NumLock non conta. Senza tastierino? Riassegna il 2P ad altri tasti dal pannello 🎮.',
