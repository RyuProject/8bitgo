...
const it: Translation = {
  ...
  game: {
    ...
    ageGateBody: 'Questo gioco è disponibile solo per chi ha almeno 18 anni. Inserisci la tua data di nascita per continuare.',
    birthDate: 'Data di nascita',
    ageGateContinue: 'Verifica e continua',
    ageGatePrivacy: 'La data di nascita viene usata solo in questa pagina per calcolare l’età. Non viene salvata né inviata al server.',
  ...
  keymap: {
    ...
    customizable: 'Puoi rimapparli dal menu impostazioni dell’emulatore (in alto a destra).',
