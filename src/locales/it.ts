...
const it: Translation = {
  ...
  player: {
    ...
    tools: {
      ...
      liveStartingTitle: 'Avvio della diretta. Quando Ã¨ attiva, qui compaiono «In diretta» e il numero di spettatori.',
      ...
      liveReconnectingTitle: 'Connessione al server della diretta perduta, riconnessione in corso. Chi stava giÃ  guardando probabilmente vede ancora l’immagine.',
      pause: 'Pausa',
      resume: 'Riprendi',
      volume: 'Volume',
      mute: 'Muto',
