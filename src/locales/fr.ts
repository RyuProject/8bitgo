...
const fr: Translation = {
  ...
  player: {
    ...
    tools: {
      ...
      liveStartingTitle: 'DÃ©marrage de la diffusion. Une fois Ã©tablie, vous verrez ici « En direct » et le nombre de spectateurs.',
      liveOff: 'Hors ligne',
      liveOffTitle: 'Cette partie n’a pas pu Ãªtre diffusÃ©e, personne d’autre ne la voit. La raison est dans la console du navigateur (lignes commenÃ§ant par [live]). Cliquez pour passer en privÃ©.',
      liveReconnectingTitle: 'La connexion au serveur de direct est perdue, reconnexion en cours. Les spectateurs dÃ©jÃ  connectÃ©s voient probablement encore l’image.',
      pause: 'Pause',
      resume: 'Reprendre',
      volume: 'Volume',
      mute: 'Couper le son',
