...
const fr: Translation = {
  ...
  keymap: {
    ...
    numpad: 'Pavé num.',
    player2Note: 'La NES a toujours été jouable à deux : le 2P utilise le pavé numérique, et NumLock n’a aucune importance. Pas de pavé numérique ? Réaffectez le 2P à d’autres touches dans le panneau 🎮.',
