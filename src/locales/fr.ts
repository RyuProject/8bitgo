...
const fr: Translation = {
  ...
  auth: {
    ...
    weibo: 'Se connecter avec Weibo',
    weiboFailed: 'Échec de la connexion Weibo',
    weiboPending: 'Finalisation de la connexion Weibo…',
    tabCode: 'Code e-mail',
  ...
  errors: {
    ...
    weiboCancelled: 'Vous avez annulé l’autorisation sur Weibo',
    weiboNoCode: 'Weibo n’a pas renvoyé de code d’autorisation, veuillez vous reconnecter',
    weiboStateMismatch: 'La connexion Weibo n’a pas pu être vérifiée. Veuillez recommencer.',
    weiboNickname: 'Joueur Weibo',
  },
