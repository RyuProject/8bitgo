...
const fr: Translation = {
  ...
  game: {
    ...
    ageGateBody: 'Ce jeu est réservé aux personnes âgées de 18 ans ou plus. Saisissez votre date de naissance pour continuer.',
    birthDate: 'Date de naissance',
    ageGateContinue: 'Vérifier et continuer',
    ageGatePrivacy: 'Votre date de naissance sert uniquement à calculer votre âge sur cette page. Elle n’est ni enregistrée ni envoyée au serveur.',
  ...
  keymap: {
    ...
    customizable: 'Modifiable dans le menu réglages de l’émulateur (en haut à droite).',
