...
const fr: Translation = {
  ...
  player: {
    ...
    tools: {
      ...
      goLive: 'Diffuser',
      stopLive: 'Arrêter',
      liveStarting: 'Démarrage du direct…',
      liveOn: 'En direct · {n} spectateurs',
      liveLink: 'Copier le lien',
      liveCopied: 'Lien copié',
      liveFail: 'Diffusion impossible : {msg}',
      liveHint: 'L’image va directement aux spectateurs, jamais par le serveur. Ils regardent sans jouer.',
      pause: 'Pause',
      resume: 'Reprendre',
      volume: 'Volume',
      mute: 'Couper le son',
