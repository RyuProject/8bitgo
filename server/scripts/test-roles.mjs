...
check('志愿者能改自己的游戏库', can('volunteer', 'games:edit'))
check('志愿者能改自己的文章库', can('volunteer', 'posts:edit'))
check('志愿者不能改主库与其它站点内容', can('volunteer', 'content:edit') === false)
check('志愿者不能审评论', can('volunteer', 'comments:review') === false)
