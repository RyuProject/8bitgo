...
const FEATURED = [
  { slug: 'taiko-web', tagline: '本周编辑推荐 · 支持体感' },
  { slug: 'chrono-trigger', tagline: '不朽 RPG · 十三种结局' },
  { slug: 'street-fighter-ii', tagline: '联机对战 · 周末锦标赛开放报名' },
]
              ...
              >
                ...
                <div className="relative grid min-h-[300px] gap-6 p-6 sm:p-10 md:grid-cols-[1fr_auto] md:items-center">
                  <div className="max-w-xl">
                    ...
                    <p className="text-xs font-semibold text-white/80">{FEATURED[i].tagline}</p>
                    <h3 className="mt-2 text-2xl font-extrabold text-white sm:text-4xl">
                      {g.titleZh ?? g.title}
                    </h3>
                    <p className="mt-1 text-sm text-white/70">
                      {g.title} · {platform.name} · {g.year} · {g.developer}
                    </p>
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                      ...
                      <span className="text-sm text-white/70">🔥 {formatCount(g.plays)} 次游玩</span>
